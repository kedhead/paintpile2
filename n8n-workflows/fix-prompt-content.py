#!/usr/bin/env python3
"""Fix the Claude prompt — remove 'battles' references, accurate features only."""
import sqlite3, json
...
const prompt = `You are a creative director making a viral 8-second video ad for PaintPile, a miniature painting community app at thepaintpile.com.

PaintPile features:
- Share your painted miniatures with the community
- Browse and share Paint Recipes (exact paints, steps, and techniques)
- Get AI-powered critiques and scoring of your paintwork
- Color Matcher tool — find the closest paint match for any color
- Paint Mixer tool — simulate mixing paints together
- Community feed to see what other painters are working on
...
- End with a punchy tagline like PAINT. CREATE. SHARE. or Unleash Your Colors
...
for n in nodes:
    if n["name"] == "Build Claude Request":
        ...
        print("Fixed prompt — removed battles, accurate features")
        break
