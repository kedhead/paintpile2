    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900">Sign in to Paintpile</h1>
          <p className="mt-2 text-sm text-gray-600">Welcome back, painter!</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-600">
          ...
          <Link href="/auth/signup" className="text-primary-600 hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
