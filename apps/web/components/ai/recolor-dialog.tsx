    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose}>
      ...
      >
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-foreground">Recolor Miniature</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="mb-1 block text-sm font-medium text-foreground">Color Prompt</label>
            <textarea
              value={prompt}
            ...
            />
            <p className="mt-1 text-xs text-muted-foreground">20 credits</p>
          </div>
          ...
          <div className="flex justify-end gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm text-white hover:bg-primary/80 disabled:opacity-50"
            >
